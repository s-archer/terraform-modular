...
# Modified by Stephen Archer to allow Terraform to push challenge to iRule, instead of to web server location
...
#DEFAULT_DIRECTORY_URL = "https://acme-v02.api.letsencrypt.org/directory" # PRODUCTION
DEFAULT_DIRECTORY_URL = "https://acme-staging-v02.api.letsencrypt.org/directory" # STAGING

LOGGER = logging.getLogger(__name__)
LOGGER.addHandler(logging.StreamHandler())
LOGGER.setLevel(logging.INFO)

def get_chal(account_key, csr, log=LOGGER, CA=DEFAULT_CA, disable_check=False, directory_url=DEFAULT_DIRECTORY_URL, contact=None):
...
def main(argv=None):
    ...
    prepare_challenge = get_chal(args.account_key, args.csr, log=LOGGER, CA=args.ca, disable_check=args.disable_check, directory_url=args.directory_url, contact=args.contact)
    sys.stdout.write(prepare_challenge)
